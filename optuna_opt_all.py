...
OPTUNA_IVF_DI = -1   # 0 for di, 1 for ivf
...
def objective(trial):
    ...
    if OPTUNA_IVF_DI == 1:    
        ...
        X_di, y_di = preprocess_data(df_train, is_train=True, procedure_type="ALL")
        X_train, X_val, y_train, y_val = train_test_split(
            X_di, y_di,
            test_size=VALIDATION_SPLIT,
            random_state=SEED,
...
if __name__ == "__main__":
    ...
    study.optimize(objective, n_trials=100)             # 예: 100번 탐색
